...
export const module0: Module = {
  ...
  description: "Orientation and introduction to the Federal Candidate Simulator.",
  content: `
...
“You’ve declared for the **[chosen office]**. Here’s what that means:
- You’ll need **[XX CC + 2.5% approval]** for this path.  
- You’re starting with **50 CC and 0% approval.**  

Every quiz and scenario will build your support.  
  ...
  tasks: [
    {
      id: "task0-read",
      type: "read",
      prompt: "Read the orientation guide and campaign rules above.",
    },
    {
      id: "task0-choice",
      type: "write",
      prompt: "Choose your office: President, Senate, or House.",
    },
  ],
};
